        ...
        <div class="col-md-3">
          <div class="form-horizontal">
            <div class="form-group">
              <label for="" class="col-sm-4 control-label">新闻标题</label>
              <div class="col-sm-8">
                <input type="text" class="form-control"  placeholder="新闻标题" v-model="title">
              </div>
            </div>
            <div class="form-group">
              <label for="" class="col-sm-4 control-label">新闻时间</label>
              <div class="col-sm-8">
                <input type="text" class="form-control"  placeholder="新闻时间" v-model="createdtime">
              </div>
            </div>
            <div class="form-group">
...
<script>
  ...
  import {uploadSM,mannageImg,addNews} from '../../servier/index'
  export  default {
    data(){
      return{
        prevImgs:[],
    ...
    methods:{
      async getText(){
        ...
        if(this.createdtime.replace(/^\s+|\s+$/ig,'')==''){
          alert('时间不能为空')
          return
        }
        ...
        let res = await  addNews(  this.title,this.createdtime, html )
