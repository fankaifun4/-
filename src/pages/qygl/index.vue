        ...
        <div class="col-md-3">
          <div class="form-horizontal">
            <div class="form-group">
              <label for="" class="col-sm-4 control-label">奇遇名称</label>
              <div class="col-sm-8">
                <input type="text" class="form-control"  placeholder="奇遇名称" v-model="title">
              </div>
            </div>
            <div class="form-group">
              <label  class="col-sm-4 control-label">奇遇类型</label>
              <div class="col-sm-8">
  ...
  export  default {
    ...
    methods:{
      async getText(){
        ...
        let res = await  addQiyu(  this.title,this.type, html )
